...
Partial Class ObjectDemoForm
    ...
    Private Sub InitializeComponent()
        ...
        ' GroupBox3
        ' 
        GroupBox3.Controls.Add(SampleTextBox)
        ...
        ' SampleTextBox
        ' 
        SampleTextBox.Font = New Font("Segoe UI", 12F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        SampleTextBox.Location = New Point(16, 42)
        SampleTextBox.Name = "SampleTextBox"
        SampleTextBox.Size = New Size(150, 39)
